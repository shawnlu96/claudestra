  ...
  return (
    ...
    <html lang="zh-CN" suppressHydrationWarning>
      ...
      <body className="min-h-full text-base-content antialiased">
        ...
        <script dangerouslySetInnerHTML={{ __html: "(function(){try{if(window.__REACT_DEVTOOLS_GLOBAL_HOOK__)return;var R=new Map(),I=0,C=0,A=false,S=0,T=null,U=null,W=0,P=0;function fnOf(t){return typeof t===\"function\"?t:(t&&(typeof t.render===\"function\"?t.render:(typeof t.type===\"function\"?t.type:null)))}function D(v){if(v===null)return\"null\";if(Array.isArray(v))return\"arr\"+v.length;var t=typeof v;if(t===\"object\")return\"obj{\"+Object.keys(v).slice(0,4).join(\",\")+\"}\";if(t===\"function\")return\"fn\";return t+\":\"+String(v).slice(0,12)}function hooksChanged(f){var a=f.alternate;if(!a)return\"new\";var h=f.memoizedState,g=a.memoizedState,i=0,o=[];while(h&&g&&i<40){if(h.memoizedState!==g.memoizedState)o.push(i);h=h.next;g=g.next;i++}return o.join(\",\")}function usesChanged(f,k){var h=f.memoizedState,i=0;while(h&&i<40){var q=h.queue;if(q&&typeof q.getSnapshot===\"function\"){try{var cur=q.getSnapshot();if(!Object.is(cur,q.value)){var d=k+\"#\"+i+\":\"+D(q.value)+\"→\"+D(cur);U[d]=(U[d]||0)+1}}catch(e){}}h=h.next;i++}}function collect(root){var cur=root.current,n=cur.child;while(n){var fn=fnOf(n.type);if(fn&&n.alternate&&(n.memoizedProps!==n.alternate.memoizedProps||n.memoizedState!==n.alternate.memoizedState)){var k=fn.displayName||fn.name||\"?\";var e=T[k]||(T[k]={n:0,h:{},fp:String(fn).slice(0,140).replace(/\\s+/g,\" \")});e.n++;var hc=hooksChanged(n);if(hc)e.h[hc]=(e.h[hc]||0)+1;usesChanged(n,k)}if(n.child){n=n.child;continue}while(n&&!n.sibling){n=n.return;if(!n||n===cur){n=null;break}}if(n)n=n.sibling}}function flush(){A=false;var n=C,span=Math.round(performance.now()-S);C=0;if(n>=30&&P<5&&T){P++;var top=Object.keys(T).map(function(k){return[k,T[k]]}).sort(function(a,b){return b[1].n-a[1].n}).slice(0,8).map(function(p){var e=p[1],hs=Object.keys(e.h).map(function(x){return x+\":\"+e.h[x]}).join(\"|\");return p[0]+\"×\"+e.n+(hs?\"{h \"+hs+\"}\":\"\")+' fp:\"'+e.fp+'\"'});var uses=Object.keys(U||{}).map(function(k){return[k,U[k]]}).sort(function(a,b){return b[1]-a[1]}).slice(0,8).map(function(p){return p[0]+\"×\"+p[1]});var d={n:n,span:span,walked:W,top:top,uses:uses};(window.__cstraCommitBursts=window.__cstraCommitBursts||[]).push(d);try{window.dispatchEvent(new CustomEvent(\"cstra:commit-burst\",{detail:d}))}catch(e){}}T=null;U=null;W=0}window.__REACT_DEVTOOLS_GLOBAL_HOOK__={isDisabled:false,supportsFiber:true,renderers:R,inject:function(r){R.set(++I,r);return I},on:function(){},off:function(){},emit:function(){},sub:function(){return function(){}},checkDCE:function(){},setStrictMode:function(){},onCommitFiberUnmount:function(){},onPostCommitFiberRoot:function(){},onCommitFiberRoot:function(id,root){try{if(!A){A=true;S=performance.now();setTimeout(flush,0)}C++;if(C>=20&&W<12){T=T||{};U=U||{};W++;collect(root)}}catch(e){}}}}catch(e){}})();" }} />
        <I18nInit />
        {children}
      </body>
    </html>
