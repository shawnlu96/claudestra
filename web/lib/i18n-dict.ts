...
export const DICT: Record<string, string> = {
  ...
  "复制链接": "Copy link",
  "剩余": "Expires in",
  "已过期，再生成一个": "Expired — generate another",
  "用手机相机扫码，或把链接发给自己，或在中继首页输入短码。10 分钟内有效，只能用一次。":
    "Scan with your phone camera, send yourself the link, or type the code on the relay home page. Valid for 10 minutes, single use.",
  "这张邀请经中继加入：点「加入」时才真正连到对方，能找哪些 agent 以加入结果为准。":
    "This invite goes through the relay: the actual connection happens when you click Join, and the join result tells you which agents you can reach.",
  "用账号密码登录": "Sign in with username and password",
  "用配对码把这个浏览器接到你的电脑": "Pair this browser with your computer using a code",
  "配对码": "Pairing code",
  "配对": "Pair",
  "配对码是 8 位": "The pairing code has 8 characters",
  "配对失败": "Pairing failed",
  "网络错误，请重试": "Network error, please try again",
  "配对码不能为空": "Pairing code is required",
  "尝试过于频繁，请稍后再试": "Too many attempts — try again later",
  "这台电脑的 Claudestra 没有响应，请稍后再试": "Claudestra on that computer didn't respond — try again later",
  "配对码无效或已过期，请在电脑上重新运行 claudestra pair": "Invalid or expired code — run claudestra pair on the computer again",
  "在电脑的终端里运行": "In a terminal on the computer, run",
  "，会显示二维码、链接和这个 8 位码；10 分钟内有效，只能用一次。": " — it prints a QR code, a link and this 8-character code; valid for 10 minutes, single use.",
  "账号": "Username",
  "密码": "Password",
  "登录": "Sign in",
