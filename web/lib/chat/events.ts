...
export type WebStreamEvent =
  ...
  /** seq/sid(v2.23.2+):来源 jsonl 记录的全文件行号 + 会话 id——前端与历史游标比对判重 */
  | { t: "tool"; id?: string; name: string; summary: string; state: "running" | "done" | "error"; detail?: string; seq?: number; sid?: string }
